...
if [ $stage -le 2 ]; then
  ...
  dir=exp/dnn_pretrain-dbn_dnn_ctlab_dnnlab_SCW_`echo $2 | tr " " "_"`
  #ali=../dirha_wsj5k_fbank_pitch_fmllr_clean/exp/tri4_ali # close talking labels
  ali=../dirha_wsj5k_fbank_pitch_fmllr_clean/exp/dnn_pretrain-dbn_dnn_SCW_-8_-7_-6_-5_-4_-3_-2_-1_0_1_2_3_4_5_6_7_8_ali
 ...
 gmmdir=../dirha_wsj5k_fbank_pitch_fmllr_clean/exp/dnn_pretrain-dbn_dnn_SCW_-8_-7_-6_-5_-4_-3_-2_-1_0_1_2_3_4_5_6_7_8 # bisogna mettere quello clean per la decodifica perche' tied-states sono quelli
